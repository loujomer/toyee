...
### [[07. Apply sensitivity labels for data protection#Apply sensitivity labels with Copilot for Microsoft 365 for secure collaboration|Sensitivity labels and Microsoft Copilot for Microsoft 365]]
